...
var kort = document.getElementById('kora');
var oss = document.getElementById('oss');
var selectt = document.getElementById('selectt');
var select = document.getElementById('select');
var filterbarr = document.getElementById('filterbarr');
function selectThing() {
  selectt.style.display = 'inline';
  selectt.onclick = deselectThing;
}

function deselectThing() {
  selectt.style.display = 'none';
}


function hackScreen() {
  body.style.backgroundImage = 'url(hack1.gif)';
...
/*  for (i = 0; i < 1000; i++) {
    ...
    setTimeout(function(){ beep();}, 400);
    setTimeout(function(){ beep();}, 500);
    setTimeout(function(){ beep();}, 600);
    setTimeout(function(){ beep();}, 700);
    setTimeout(function(){ beep();}, 800);
...
hack.onclick = hackScreen;
selectt.style.display = 'none';
select.onclick = selectThing;
